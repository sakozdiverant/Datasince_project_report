...
os.system('copy "C:\\plan_install\\Почта.url" "C:\\Users\\Public\\Desktop"') # ярлык для почты
...
def sech(): #Проверка каталога на соответствие
    ...
    spisok = ['7z920-x64.msi', 'ChromeStandaloneSetup.exe', 'ChromeStandaloneSetup64.exe',
              'appsetup.exe', 'chngpsw.sql', 'FortiClient', 'Keyboard Mouse Test V 0.4(portable)',
              'KZLocale_1.2.1.7', 'LibreOffice_6.0.1_Win_x64.msi', 'LibreOffice_6.0.1_Win_x86.msi', 'LM', 'Asbuka',
              'off-USB.bat', 'on-USB.bat', 'update ERPOR.sql', 'Мобильный эксперт.lnk', 'Почта.ink']
...
def os_64():
    ...
    os.system('"C:\plan_install\FortiClient 6.0.7\FortiClientSetup_x64.exe" /quiet')
...
def os_32():
    ...
    os.system('"C:\plan_install\FortiClient 6.0.7\FortiClientSetup_x86.exe" /quiet')
    os.system('"C:\plan_install\off-USB.bat"')
